...
def forecast_for_date(feature, symbol, target_date, target_start_date, target_end_date, models):
...
if __name__ == "__main__":
    ...
    models=[]
    for i in range(19):
        model.load_model(folder+f'\{symbol}_xgboost_model_20241208_model'+str(i)+'.json') 
        models.append(model)
    ...
    data,final_predictions_mapped=forecast_for_date(features, symbol, target_date,target_start_date, target_end_date, models)
