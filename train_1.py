...
if __name__ == "__main__":
    ...
    profit_to_buy_options = [-3, -5]  # Example list of loss percentages to trigger a buy
    profit_to_sell_options = [40, 50]  # Example list of profit percentages to trigger a sell
