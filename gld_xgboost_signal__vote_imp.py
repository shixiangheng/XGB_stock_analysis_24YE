...
from gld_xgboost_signal import fetch_data,add_features,calculate_rsi,backtest,majority_vote


# Forecast for a Specific Date
def forecast_for_date(symbol, target_date, target_start_date, target_end_date, models):
...
if __name__ == "__main__":
    ...
    data,final_predictions_mapped=forecast_for_date(symbol, target_date,target_start_date, target_end_date, models)
    backtest(data, final_predictions_mapped, data.index)
